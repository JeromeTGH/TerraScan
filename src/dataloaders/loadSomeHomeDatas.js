import { tblHomeData } from "../application/AppData";
import { LCDclient } from "../lcd/LCDclient";

export const loadSomeHomeDatas = async () => {

    // Rechargement de ces données SEULEMENT SI ça n'a pas déjà été fait auparavant (toujours en mémoire, je veux dire)
    if(Object.keys(tblHomeData).length === 0) {

        // Instanciation d'une classe de requetage LCD
