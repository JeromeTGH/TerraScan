...
export const loadGovInfos = async () => {
    ...
    const rawDepositParameters = await lcd.gov.getDepositParameters().catch(handleError);
    ...
    const rawVotingParameters = await lcd.gov.getVotingParameters().catch(handleError);
    ...
    const rawTallyParameters = await lcd.gov.getTallyParameters().catch(handleError);
