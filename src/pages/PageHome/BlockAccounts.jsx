...
const BlockAccounts = () => {
    return (
        <div className={"boxContainer " + styles.accountsBlock}>
            ...
            <br />
            → <strong>Community Pool</strong> : shared account <Link to="/accounts/terra1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8pm7utl">here</Link>, but no specific address (access is only through API)<br />
        </div>
    );
};
