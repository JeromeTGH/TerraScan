...
export class StakingAPI {
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/pool
    async getStakingPool(params = new URLSearchParams()) {
        return this.apiRequester.get(this.paths.getStakingPool, params);
    }

    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/params
    async getStakingParameters(params = new URLSearchParams()) {
        return this.apiRequester.get(this.paths.getStakingParameters, params);
    }

    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/delegations/terra12gw6wuav6cyezly29t66tpnty5q2ny3d2r88gd
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/validators/terravaloper120ppepaj2lh5vreadx42wnjjznh55vvktp78wk/delegations
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/delegators/terra12gw6wuav6cyezly29t66tpnty5q2ny3d2r88gd/unbonding_delegations
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/delegators/terra12gw6wuav6cyezly29t66tpnty5q2ny3d2r88gd/redelegations
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/validators/terravaloper120ppepaj2lh5vreadx42wnjjznh55vvktp78wk
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/staking/v1beta1/validators?pagination.limit=9999
