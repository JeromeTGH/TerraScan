...
export class BankAPI {
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/bank/v1beta1/supply?pagination.limit=9999
    async getTotalSupplies(params = new URLSearchParams()) {
        return await this.apiRequester.get(this.paths.getTotalSupplies, params);
    }

    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/bank/v1beta1/balances/terra1jgp27m8fykex4e4jtt0l7ze8q528ux2lh4zh0f (adresse le l'Oracle Pool)
    ...
    // Exemple d'appel : https://terra-classic-lcd.publicnode.com/cosmos/bank/v1beta1/balances/terra12gw6wuav6cyezly29t66tpnty5q2ny3d2r88gd
